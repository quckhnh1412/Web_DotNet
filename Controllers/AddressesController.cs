    ...
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Addresses != null ? 
                          ...
                          Problem("Entity set 'AppDBContext.Addresses'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Street,Ward,District,Province")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Street,Ward,District,Province")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
